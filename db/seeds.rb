...
# lisa = User.create({first_name: "Lisa", last_name: "Vogt", email: "lisavogt.sf@gmail.com", password: "123456", password_confirmation: "123456"})
# jesse = User.create({first_name: "Jesse", last_name: "Moore", email: "moore.jesseb@gmail.com", password: "123456", password_confirmation: "123456"})
# angga = User.create({first_name: "Angga", last_name: "Putra", email: "angga.w.putra@gmail.com", password: "123456", password_confirmation: "123456"})
# will = User.create({first_name: "Will", last_name: "Curotto", email: "kekknyx@gmail.com", password: "123456", password_confirmation: "123456"})
# mark = User.create({first_name: "Mark", last_name: "Centoni", email: "marklc44@gmail.com", password: "123456", password_confirmation: "123456"})
...
# mark.posts.create({title: "Awesome blog is awesome", content: "Reflect on the fragility and preciousness of life. Impermanence and change is a powerful teacher and teaching. Briefly notice any emotions, thoughts or sensations that may be driving fear and anxiety and let them be. Slow down and ask yourself what is really happening. Picture yourself releasing the burden you feel from sorrow, regret or resentment. Stop and focus on whatever is being carried within you and let be. Slow down and ask yourself what is really happening. Give yourself a break."})
# mark.posts.create({title: "Superstar", content:"Who is really in pain when we hold on to resentments and grudges? Let the muscles in your neck and shoulders relax. Inhale slowly and exhale slowly. Stop and take a slow breath. Anxiety and panic will pass. Love is the first seed of the soul. Bring love into your heart, into your breath and into your being. Just acknowledge what's there and let be. May you be at peace."})
